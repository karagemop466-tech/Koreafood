...
**469 restaurants and cafes.** Seoul 272 · Busan 150 · Suwon 14 · Daejeon 20 · Cheonan 13.
...
**Prices are not gone for good — they are parked.** `prices-review.md` lists all 469 restaurants and cafes with a blank price field, the source rules, and instructions for filling it in. Prices can be added there whenever a real source is found, without disturbing the verified entries in the city guides.

## Travel tools & Bookmarks

* **[By location](cities/by-location.md)** — jajangmyeon, KBBQ, galbijim, tonkatsu, spicy cold noodles, steak, local Korean food and cafes, with restaurants and cafes in separate location tables.
...
* **[Bookmarks CSV](restaurants-bookmarks.csv)** — all **469 verified restaurants and cafes** with English/Korean names, neighborhood, Michelin status, and an official source URL for each. Import or copy the Korean names straight into Naver Map.

## Research status

* [Research log](research-log-2026-08.md) — what has been checked and what is still in progress
* [Sources and notes](sources-and-notes.md) — how sources, hours, and prices are evaluated
* [Full project overview](README.md)

The best next step is to tell us your hotel neighborhoods. Then the list can be turned into day-by-day food routes with walking and subway convenience.
