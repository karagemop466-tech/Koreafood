...
**297 restaurants.** Seoul 138 · Busan 113 · Suwon 14 · Daejeon 20 · Cheonan 12.
...
**Prices are not gone for good — they are parked.** `prices-review.md` lists all 297 restaurants with a blank price field, the source rules, and instructions for filling it in. Prices can be added there whenever a real source is found, without disturbing the verified entries in the city guides.
...
* **[Bookmarks CSV](restaurants-bookmarks.csv)** — all **297 verified restaurants** with English/Korean names, neighborhood, Michelin status, and an official source URL for each. Import or copy the Korean names straight into Naver Map.
