# Korea 2026 Food Trip & Culinary Map 🇰🇷
...
* **399 verified restaurants.** Seoul 218 · Busan 134 · Suwon 14 · Daejeon 20 · Cheonan 13. (Passes 84–93 on 19 August 2026: **+21** jajangmyeon, KBBQ and cafes, focused on Myeong-dong, Gangnam, Hongdae, Dongdaemun and Busan; **Gaehwa, Wan Chai and Samwon Garden removed** because two official pages disagree on hours. Passes 94–103 on 19 August 2026: **+24 / −1** — jajangmyeon, KBBQ, galbijim and cafes again in the same areas plus Busan; **Haeundae Ilpum Hanwoo removed** because Visit Busan and VisitKorea disagree on hours and phone at the same address. Location-organised tables: [cities/by-location.md](cities/by-location.md).)
* **No prices.** Prices previously shown here were not sourced from the restaurants. Only MICHELIN's own ₩/₩₩ bands appear, where MICHELIN publishes them. Prices are parked rather than abandoned — **[prices-review.md](prices-review.md)** holds a blank row for all 399 restaurants, the sourcing rules, and the leads worth chasing.
...
* **Bookmarks:** **[restaurants-bookmarks.csv](restaurants-bookmarks.csv)** — 399 rows, each with an official source URL.
