...
* **423 verified restaurants.** Seoul 234 · Busan 142 · Suwon 14 · Daejeon 20 · Cheonan 13. (Passes 104–113 on 19 August 2026: **+25 / −1** — tonkatsu, spicy cold noodles, fancy steak, Korea-only dishes, KBBQ and cafes, focused on Myeong-dong, Gangnam, Hongdae, Dongdaemun and Busan; **NOBIZIB / Neobijip removed** because VisitKorea and Visit Seoul disagree on hours and phone at the same Myeongdong address. Location-organised tables: [cities/by-location.md](cities/by-location.md).)
* **No prices.** Prices previously shown here were not sourced from the restaurants. Only MICHELIN's own ₩/₩₩ bands appear, where MICHELIN publishes them. Prices are parked rather than abandoned — **[prices-review.md](prices-review.md)** holds a blank row for all 423 restaurants, the sourcing rules, and the leads worth chasing.
...
* **Bookmarks:** **[restaurants-bookmarks.csv](restaurants-bookmarks.csv)** — 423 rows, each with an official source URL.
